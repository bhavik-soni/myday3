    ...
    <>
      <form class="m-4">
        <div class="w-full border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
          ...
          <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800 selection:bg-fuchsia-300 selection:text-fuchsia-900">
            ...
            <textarea
              id="input"
              rows="8"
              class="block w-full px-0 text- text-gray-800 bg-white border-0 dark:bg-gray-800 focus:outline-none dark:text-white dark:placeholder-gray-400"
